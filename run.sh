...
# The victim program uses cpu0, in order to minimize interference, the doppelganger will use another cpu thread.
# Skipping over cpu1 as this thread would be under the same cpu core as cpu0.
